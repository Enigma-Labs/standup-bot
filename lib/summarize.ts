...
CATEGORIES — group every issue into exactly one of these five buckets, in this order. Use *bold* Slack formatting for each header. Skip any category with zero issues across both sections.
